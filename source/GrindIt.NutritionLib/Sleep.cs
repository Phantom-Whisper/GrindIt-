...
namespace GrindIt.NutritionLib
{
    ...
    public class Sleep
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Sleep"/> class with a specified bed time, wake-up time, and serializer.
        ...
        /// <summary>
        /// Calculates the total sleep duration by subtracting the bed time from the wake-up time.
        /// </summary>
